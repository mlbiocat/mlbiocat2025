...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(100px, 1fr)); gap: 10px; align-items: center; justify-items: center; margin-top: 20px;">
    <img src="images/eth.png" alt="ETH Zurich" style="max-width: 100%; height: auto;" />
    <img src="images/basel.png" alt="University of Basel" style="max-width: 100%; height: auto;" />
    <img src="images/zhaw.png" alt="ZHAW" style="max-width: 100%; height: auto;" />
    <img src="images/ccbio.png" alt="CCBIO" style="max-width: 100%; height: auto;" />
</div>
